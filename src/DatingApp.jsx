...
const sampleProfiles = [
  ...
  },
  {
    ...
    horoscope: "Leo",
    gender: "Male",
    bio: "I'm a musician and a coffee enthusiast.",
  },
  {
    id: 4,
    name: "Sophia",
    ...
    horoscope: "Pisces",
    gender: "Female",
    bio: "I'm passionate about photography and yoga.",
  },
  {
    id: 5,
    name: "James",
    ...
    horoscope: "Scorpio",
    gender: "Male",
    bio: "I like playing basketball and watching movies.",
  },
  {
    id: 6,
    name: "Olivia",
    ...
    horoscope: "Aquarius",
    gender: "Female",
    bio: "I'm a bookworm and love going to art galleries.",
  },
  {
    id: 7,
    name: "William",
    ...
    horoscope: "Taurus",
    gender: "Male",
    bio: "I'm a foodie and enjoy trying new cuisines.",
  },
  {
    id: 8,
    name: "Isabella",
    ...
    horoscope: "Gemini",
    gender: "Female",
    bio: "I love dancing and going to music festivals.",
  },
  {
    id: 9,
    name: "Alexander",
    ...
    horoscope: "Cancer",
    gender: "Male",
    bio: "I'm passionate about fitness and health.",
  },
  {
    id: 10,
    name: "Sophie",
    ...
    horoscope: "Virgo",
    gender: "Female",
    bio: "I'm a dog lover and enjoy outdoor activities.",
  },
  {
    id: 11,
    name: "Daniel",
    ...
    horoscope: "Capricorn",
    gender: "Male",
    bio: "I'm a tech enthusiast and love coding.",
  },
  {
    id: 12,
    name: "Mia",
    ...
    gender: "Female",
    bio: "I'm adventurous and love traveling to exotic places.",
  },
  {
    id: 13,
    name: "Benjamin",
    ...
    horoscope: "Pisces",
    gender: "Male",
    bio: "I'm a nature lover and enjoy hiking in the mountains.",
  },
  {
    id: 14,
    name: "Charlotte",
    ...
    horoscope: "Aries",
    gender: "Female",
    bio: "I'm a fashionista and love designing clothes.",
  },
  {
    id: 15,
    name: "Samuel",
    ...
    horoscope: "Leo",
    gender: "Male",
    bio: "I'm a movie buff and enjoy watching classic films.",
  },
  {
    id: 16,
    name: "Emily",
    ...
    horoscope: "Libra",
    gender: "Female",
    bio: "I'm an animal lover and enjoy volunteering at shelters.",
  },
  {
    id: 17,
    name: "Matthew",
    ...
    horoscope: "Taurus",
    gender: "Male",
    bio: "I'm a gamer and love playing video games.",
  },
  {
    id: 18,
    name: "Amelia",
    ...
    horoscope: "Gemini",
    gender: "Female",
    bio: "I'm a music junkie and love going to concerts.",
  },
  {
    id: 19,
    name: "David",
    ...
    horoscope: "Cancer",
    gender: "Male",
    bio: "I'm a coffee connoisseur and enjoy trying different blends.",
  },
  {
    id: 20,
    name: "Ella",
    ...
    horoscope: "Virgo",
    gender: "Female",
    bio: "I'm a beach lover and enjoy surfing and snorkeling.",
  },
];
...
const DatingApp = () => {
  ...
  const handleProfileClick = (profileId) => {
    ...
    if (clickedProfiles.length === 1) {
      ...
      const options = {
        ...
        headers: {
          "X-RapidAPI-Key":
            "e85ef444c0msh8b70ca519eadeebp1f4454jsnf8d69a51c6d8",
  ...
  const toggleModal = (content) => {
    ...
    setModalOpen(!modalOpen); // Toggle the modal state
  };

  const closeModal = () => {
    // Reset the modal contente
    setModalContent("");
    // Close the modal
    setModalOpen(false);
  ...
  const addProfile = () => {
    const { name, age, horoscope, gender, bio } = newProfile;

    // Input validation
    if (!name || !age || !horoscope || !gender || !bio) {
  ...
  const filterProfiles = () => {
    if (filterHoroscope === "All") {
      ...
      return profiles.filter(
        (profile) => profile.horoscope === filterHoroscope
      );
    }
  };
  ...
  return (
    <div className="dating-app">
      ...
      <h1 className="Title">Affinity</h1> 
        ...
        {filterProfiles().map((profile) => (
          <div
            ...
            className={`profile-card ${
              clickedProfiles.some((p) => p.id === profile.id) ? "glow" : ""
            }`}
