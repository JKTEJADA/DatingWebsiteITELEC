    ...
    <div className="dating-app">
      <nav className="navbar navbar-expand-lg navbar-dark">
        ...
        <a className="navbar-brand" href="../App.js">
          <h1 className="font-effect-neon">Affinity</h1>
        </a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ml-auto">
            <li className="nav-item active">
              <a className="text-type" href="../App.js">
                Landing Page
              </a>
            </li>
      ...
      <div className="add-profile">
        ...
        <input
          ...
          onChange={(e) =>
            setNewProfile({ ...newProfile, image: e.target.value })
          }
        />
      ...
      <div className="profile-container">
        {filterProfiles().map((profile) => (
          ...
          >
            ...
            <button onClick={() => setEditProfileToEdit(profile.id)}>
              Edit
            </button>
          </div>
        ))}
